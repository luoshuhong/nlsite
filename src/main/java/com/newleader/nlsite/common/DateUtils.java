...
public class DateUtils {
	...
	/**
	 * 时间排序
	 * @param dateList 原始需要排序的时间list
	 * @param parten   原始时间格式
	 * @param type	   0：升序 1：降序
	 * @return 排序后的list --> ArrayList
	 */
	public static List<String> sortDate(List<String> dateList, String parten, int type) {
	...
	public static void main(String[] args) {
		...
		list.add("2015-11-07");
		list.add("2012-10-08");
		System.out.println(sortDate(list,DateUtils.Simple_Date_Format,1));
	}
}
